...
foreach($result_p as $rows_p)
    {
         $ct = $rows_p['id_cart'];
         $sql_w = "SELECT * FROM transaction_wallet_info WHERE id_cart = $ct ORDER BY id DESC";
                         ...
                         <div class="date" style="display: flex;flex-wrap: wrap;">
                           ...
                           $counter = 0;
                             ...
                             <div class="ord" style="display: flex">
                                 ...
                                 <div><div style="width: 400px;"><?php echo $rows2['payment_type']; ?></div>
                                 </div>
