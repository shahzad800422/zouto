...
<div id="exTab2" class="container">
    ...
    <div class="tab-content ">
        <div class="tab-pane active" id="1">
            ...
            <?php
            $result = Helper::dbQuery('SELECT * FROM matching_cost where id_cart="' . $_GET['cart'] . '" AND id_customer="' . $_GET['id'] . '" ORDER BY id DESC');
            $get_data = @$result[0];
            ?>
            ...
            <?php
            $result_2 = Helper::dbQuery('SELECT * FROM transaction where id_cart="' . $_GET['cart'] . '" AND id_customer="' . $_GET['id'] . '" ORDER BY id DESC LIMIT 1');
            $get_data_2 = @$result_2[0];
                ...
                <div style="float: left;width: 100%;padding: 20px 0;text-align: center;">
                    <form id="matching_capture_amount_form" action="<?= $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ?>" method="POST">
                        ...
                        <div class="form-group" style="display: inline-flex;height: 34px;margin: 5px 0;">
                            ...
                            <input style="width: fit-content;margin: 0 5px;" class="form-control" type="number" name="paid_amount" step="0.01" min="0" max="<?= $get_data_2['amount_capturable'] ?>" value="<?= $get_data_2['amount_capturable'] ?>" <?php if ($get_data_2['payment_status'] != 'requires_capture') {
                                                                                                                                                                                                                                                            echo 'readonly';
                                                                                                                                                                                                                                                        } ?>>
                            <input class="btn btn-primary" type="submit" value="Capture" <?php if ($get_data_2['payment_status'] != 'requires_capture') {
                                                                                                echo 'disabled';
                                                                                            } ?>>
                        </div>
                ...
                <tbody>
                    ...
                    ?>
                                <tr class="close-<?= $result['id'] ?>">
                                    ...
                                    <td><a href="javascript:void(0)" id="openModal" product_color="<?php echo $result['product_color']; ?>" product_size="<?php echo $result['product_size']; ?>" value="<?php echo $result['id']; ?>" quantity="<?php echo $result['qty'] ?>" net_price="<?php if ($result['net_price']) {
                            ...
                            <form class="parcel_information">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parcel" id="parcel">
                                        <?php
                                        $res = Helper::dbQuery("SELECT * FROM customer_product_wishlist WHERE parcel_number IS NOT NULL AND parcel_for=0 GROUP BY parcel_number");
                                        if (count($res) > 0) {
                                            foreach ($res as $result) {
                                                $hs_limit = $result['limit_product'];
                                                $date1_ts = date('Y-m-d H:i:s');
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding-bottom: 50px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="date" value="" class="form-control setDate">
                                    <span id="hsError"></span>
                                </div>
...
<div class="col-md-12" style="text-align: center;padding: 30px 0;font-size: 18px;font-weight: bold;">
    <a href="{{ env('APP_URL') }}/index2_customer?id=<?php echo $_GET['id']; ?>&cart=<?php echo $_GET['cart']; ?>">
        < arrière</a>
            <a href="{{ env('APP_URL') }}/index_new">next ></a>
</div>

<script type="text/javascript" src="https://js.stripe.com/v3"></script>
<script type="text/javascript" src="{{ asset('js/product_payment_new.js') }}"></script>
