                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control pro_stat" data-invoice="<?php echo $result_awb['invoice_number']; ?>" data-customer_id="<?php echo $result_awb['id_customer']; ?>" data-awb="<?php echo $result_awb['awb_number']; ?>" style="width: 145px">
                                        ...
                                        <option value="8" <?php if ($result_awb['parcel_status'] == '8') {
                                                                echo 'selected';
                                                            } ?>>Colis ralentit</option>
                                    </select>
                                </td>
                            </tr>
                    <?php
                    ...
                    if (count($res_sup) > 0) {
                        foreach ($res_sup as $result_sup) {
                            if (!empty($result_sup['supplier_track_number'])) {
                                $id_customer = $result_sup['id_customer'];
                                $result3 = Helper::dbQuery("SELECT * FROM shopify_customers WHERE id_customer='$id_customer'");
                                $get_data = $result3[0];
                    ?>
                                <div>
                                    <table class="no_border">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div style="min-width: 130px" id="openModal6" value="<?php echo $result_sup['id']; ?>" data-supp_tracking="<?php echo $result_sup['supplier_track_number']; ?>" weight="<?php echo $result_sup['parcel_weight']; ?>" l="<?php echo $result_sup['parcel_l']; ?>" b="<?php echo $result_sup['parcel_b']; ?>" h="<?php echo $result_sup['parcel_h']; ?>" selected_shipping="<?php echo $result_sup['selected_shipping']; ?>" style="cursor: pointer"><?php echo $result_sup['supplier_track_number']; ?></div>
                                                    <div style="display: none">
                                                        <?php
                                                        $trck_num = $result_sup['supplier_track_number'];
                                                        $res_sup_pro = Helper::dbQuery("SELECT id, title, id_customer, selected_shipping, parcel_status, invoice_number, supplier_track_number, parcel_weight, parcel_l, parcel_b, parcel_h, source FROM customer_product_wishlist where supplier_track_number = '$trck_num'");

                                                        if (count($res_sup_pro) > 0) {
                                                            $cnt = 1;
                                                            foreach ($res_sup_pro as $result_sup_pro) {
                                                        ?>
                                                                <span><?php echo $cnt . '. ' . $result_sup_pro['title']; ?></span><br>
                                                        <?php
                                                                $cnt++;
                                                            }
                                                        }
                                                ...
                                                <td>
                                                    <div style="min-width: 80px"><b><?php echo $result_sup['source']; ?></b></div>
                                                </td>
                                                <td>
                                                    <div style="min-width: 100px"><?php if (!empty($result_sup['parcel_weight']) && !empty($result_sup['parcel_l'])) {
                                                ...
                                                <td>
                                                    <div style="min-width: 90px"><?php echo $get_data['firstname'] . ' ' . $get_data['lastname']; ?></div>
                                                </td>
                                                <td>
                                                    <div style="min-width: 160px"><?php echo $get_data['address1'];
                                                                                    if ($get_data['city']) {
                                                                                        echo '( ' . $get_data['city'] . ' )';
                                                                                    } ?></div>
                                                </td>
                                                <td>
                                                    <div style="min-width: 90px"><?php echo $get_data['phone']; ?></div>
                                                </td>
                                                <td>
                                                    <select class="form-control pro_statt" data-invoice="<?php echo $result_awb['invoice_number']; ?>" data-customer_id="<?php echo $result_awb['id_customer']; ?>" data-awb="<?php echo $result_awb['awb_number']; ?>" data-supplier_track_number="<?php echo $result_sup['supplier_track_number']; ?>">
                                                        ...
                                                        <option value="8" <?php if ($result_sup['parcel_status'] == '8') {
                                                                                echo 'selected';
                                                                            } ?>>Oups</option>
                                                    </select>
                                                </td>
...
<script>
    ...
    $('.move_to_archive').click(function() {
        ...
        $.ajax({
            type: "POST",
            url: APP_URL + "/move_awb_to_archive",
            data: {
                awb: awb,
                invoice: invoice
            },
    ...
    $(document).on("click", "#openModal6", function(e) {
        ...
        $('.pro_titless').html($(this).next().html())
...
<div class="col-md-12">
    <a target="_blank" href="{{ env('APP_URL') }}/awb_archive" style="color: #000">Archived AWB</a>
</div>
